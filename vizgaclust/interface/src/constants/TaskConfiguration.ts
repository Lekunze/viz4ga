...
const MODIFIED_HUBERT_T = ["modified_hubert_t", 1]
const DUNNS_INDEX = ["dunns_index", 1]
...
export const LABELED_CVI_DICT = {
    ...
    "cvi-1": "Banfeld-Raferty",
    "cvi-2": "Modified Hubert T",
    "cvi-3": "I-Index",
    "cvi-5": "Dunns Index",
    "cvi-404": "Not Selected"
    // "cvi-8": "Davies Bouldin",
}
