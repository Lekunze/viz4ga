...
class App extends React.Component<{}, AppState> {
    ...
    constructor(props: {}) {
        ...
        this.state = {
            ...
            best: "None",
            algorithm: "ag-404",
            metric: "cvi-404",//"I-INDEX & MODIFIED-HUBERT-T & BANFELD-RAFERTY",
            partitions: [],
            partition: "None",
            partitionData: [],
            partitionDisableStatus: {},
    ...
    updateViewTaskViz = () => {
        ...
        const extLabel = "Visualizing Genetic Algorithms with Auto-Clustering"
    ...
    liveTaskUpdates = (data) => {
        ...
        if("algorithm" in parsedData){
            console.log("Algorithm: ", parsedData.algorithm)
            // this.setState({metaLearning: true})
            this.setState({algorithm: parsedData.algorithm})
        }else if("metric" in parsedData){
            console.log("Metric: ", parsedData.metric[0])
    ...
    setCrossover = (crossover: string) => {
        this.setState({crossover: crossover});
    }

    setMutation = (mutation: string) => {
        this.setState({mutation: mutation});
    }
    ...
    startTaskRun = () => {
        ...
        const { metaLearning, algorithm, metric, uploadedData,
            uploadedCSV, resultPreference, datasetName, timeBudget,
        ...
        testFunction(payload).then(result => {
            ...
            this.setState({
                ...
                best: result.data.bconfig,
                fitness: result.data.bfitness,
            })
        })
    }
            ...
            <Grommet theme={theme}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Box gridArea="header" background="#2a3142">

                                <Header pad="medium" height="xsmall" alignSelf={headerPosition}>
                                    <Anchor
                                        href="#"
                                ...
                                <OutlinedBox gridArea="nav">
                                    <Sidebar background="#fff">
                                        ...
                                        <ConfigPanel
                                            ...
                                            setCrossover={this.setCrossover}
                                            setMutation={this.setCrossover}
                                  ...
                                  {/*<AccordionPanel>*/}
                                    ...
                                    {/*</Box>*/}
                                      <Box pad="medium">
                                        ...
                                        <Box direction={"row"}>
                                            <Box>
                                                <Heading level={5} margin={{bottom: "small", top: "none"}}> Chromosomes (i.e. hyper-parameters) </Heading>
                                                <Select
                                                options={partitions}
                                                value={partition}
